...
const Login = ({ setClientName, setSocket }) => {
	...
	return (
		<div className='bg-light row justify-content-center align-items-center h-100 rounded-bottom'>
			<div className='bg-main col-sm-8 col-md-6 col-lg-5 col-xl-4 form-floating text-center rounded-3'>
				...
				<span className='error-field span-error my-1'>{error}</span>
				<br />
